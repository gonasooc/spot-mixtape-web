      ...
      >
        <article className="flex flex-col bg-acid px-5 py-12 text-ink sm:px-8 sm:py-16 md:border-r md:border-ink/20">
          ...
          <p className="mt-6 mb-0 text-sm text-ink/70">
            앱은 인증된 계정과 그 계정에 연결된 데이터베이스 레코드를 먼저
            삭제합니다. 이 단계가 실패하면 아무것도 지워지지 않은 상태로 남아
            다시 시도할 수 있습니다. 삭제가 확인되면 비공개 스토리지에 업로드된
            미디어 파일을 정리한 뒤 기기에서 로그아웃하며, 미처 정리되지 못한
            파일은 소유자 전용 정책 때문에 누구도 접근할 수 없고 운영 절차로
            마저 제거됩니다.
          </p>
        </article>
